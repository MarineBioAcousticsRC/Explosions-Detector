% merge_explosions
% Script that is designed to merge output from xcorr_explosion_p2_v4 after GPLreview.

clearvars

% STUFF TO MODIFY:
inDir = 'G:\SOCAL_N_63\SOCAL_N_63_Explosions'; % Location of the files to be merged.
